...
export default {
    ...
    LIST_CONTACTS: `${REACT_APP_SUSS_URL}/api/v1/message/3/list`,
    ...
    LIST_MESSAGES: `${REACT_APP_SUSS_URL}/api/v1/message/3/list`,
    APP_SERVICES: `${REACT_APP_SUSS_URL}/api/v1/application/:app_id/service/list`,
